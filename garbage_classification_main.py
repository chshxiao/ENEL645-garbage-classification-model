...
# # testing loop
# labels_test, predict_test = image_model_predict(image_model_test, img_path, test_size)
...
labels_test, predict_test = entire_model_predict(model, image_model_test, img_test_loader,
  text_model_test, text_test_loader, device)
cm = confusion_matrix(labels_test, predict_test)
print(cm)